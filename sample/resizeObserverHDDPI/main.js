...
var checkerWGSL = `struct Uniforms {
  color0: vec4f,
  color1: vec4f,
  size: u32,
};
...
var UniformOffset;
(function (UniformOffset) {
    UniformOffset[UniformOffset["color0"] = 0] = "color0";
    UniformOffset[UniformOffset["color1"] = 4] = "color1";
    UniformOffset[UniformOffset["size"] = 8] = "size";
