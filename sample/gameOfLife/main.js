...
let wholeTime = 0, loopTimes = 0, buffer0, buffer1;
let render;
function resetGameData() {
    ...
    render = () => {
        ...
        passEncoderCompute.dispatchWorkgroups(GameOptions.width / GameOptions.workgroupSize, GameOptions.height / GameOptions.workgroupSize);
